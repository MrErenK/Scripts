...
function installpkgs() {
  ...
  then
    ...
    x11proto-core-dev libx11-dev libgl1-mesa-dev unzip fontconfig ca-certificates bc cpio bsdmainutils lz4 aria2 rclone ssh-client libssl-dev rsync python-is-python3 libarchive-tools repo
  else
